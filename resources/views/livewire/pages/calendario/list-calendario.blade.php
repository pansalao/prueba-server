                        ...
                        @if ($calendarios->isNotEmpty())
                            @foreach ($calendarios as $calendario)
                                <tr wire:key="{{ $calendario->id_calendario_academico }}"
                                    ...
                                    <td class="px-4 py-4 text-gray-900 dark:text-white">L1: {{ $calendario->semana_lapso_uno_calendario_academico }} - L2: {{ $calendario->semana_lapso_dos_calendario_academico }}</td>

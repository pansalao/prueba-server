                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form wire:submit="guardar" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Nombre del Color -->
                            <div class="w-full">
                                <x-input-label for="nombre_color" :value="__('Nombre del Color *')" />
                                <x-text-input id="nombre_color" type="text" class="w-full" wire:model.live="form.nombre_color" placeholder="Ej: Rojo Pasión" required autofocus />
